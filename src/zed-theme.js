  ...
  "themes": [
    {
      ...
      "style": {
        "background": c(p.bg),
        "border": c(p.borderStrong),
        "border.variant": c(p.borderStrong),
        "border.focused": c(p.red, '88'),
        "border.selected": c(p.borderStrong),
        "border.transparent": c(p.black, '00'),
        "border.disabled": c(p.borderStrong),
        ...
        "pane.focused_border": c(p.borderStrong),
