...
module.exports = {
  ...
  "colors": {
    ...
    "textSeparator.foreground": p.borderStrong,
    ...
    // VS Code always resolves inlineChatInput.border, so it wins over
    // input.border. Extensions built on the chat input (Claude Code among them)
    // read it for their prompt box.
    "inlineChatInput.border": p.red,
